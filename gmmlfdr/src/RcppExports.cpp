...
RcppExport SEXP _gmmlfdr_gmmr(SEXP dataSEXP, SEXP datacSEXP, SEXP kSEXP, SEXP pi0SEXP, SEXP mu0SEXP, SEXP sd0SEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_gmmlfdr_gmmr", (DL_FUNC) &_gmmlfdr_gmmr, 6},
    {NULL, NULL, 0}
};

RcppExport void R_init_gmmlfdr(DllInfo *dll) {
